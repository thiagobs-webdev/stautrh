...
class Web extends Controller
{
    ...
    {
        parent::__construct(__DIR__ . "/../../../../templates/" . CONF_VIEW_THEME . "/", $router);
    }
    ...
    public function register(?array $data): void
    {
        ...
        if (!empty($data['csrf'])) {
            ...
            if ($auth->register($user)) {
                $this->message->success("Cadastro realizado com Sucesso \o/. Faça Login para entrar!")->flash();
                $json['redirect'] = url("/entrar");
            } else {
                $json['message'] = $auth->message()->before("Ooops! ")->render();
            }
