...
namespace StautRH\Core\Database;

use StautRH\Support\Message;

/**
 * StautRH | Class Model Layer Supertype Pattern
 *
 * @author Thiago Bomfim <dev@thiagobs.me>
 * @package StautRH\Database\Models
 */
abstract class Model
{
    ...
    {
        if (!$this->required()) {
            $this->message->warning("Preencha os campos Obrigatórios* para continuar");
            return false;
        }
